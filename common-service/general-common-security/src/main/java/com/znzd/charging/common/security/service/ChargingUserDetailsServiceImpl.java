...
@Service
@AllArgsConstructor
public class ChargingUserDetailsServiceImpl implements ChargingUserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if (cache != null && cache.get(username) != null) {
			return (ChargingUser) cache.get(username).get();
		}
	...
	private UserDetails getUserDetails(R<UserInfo> result) {
		...
		return new ChargingUser(user.getUserId(), user.getDeptId(), user.getTenantId(), user.getUsername(), SecurityConstants.BCRYPT + user.getPassword(), enabled,
