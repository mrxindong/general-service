...
package com.znzd.charging.auth.endpoint;
...
public class GeneralTokenEndpoint {
	...
	public R getTokenPage(@RequestBody Map<String, Object> params, @RequestHeader(required = false) String from) {
		...
		for (String page : pages) {
			...
			if (authentication instanceof UsernamePasswordAuthenticationToken) {
				...
				if (authenticationToken.getPrincipal() instanceof SysUser) {
					SysUser user = (SysUser) authenticationToken.getPrincipal();
				...
				if (authenticationToken.getPrincipal() instanceof ChargingUser) {
					ChargingUser user = (ChargingUser) authenticationToken.getPrincipal();
